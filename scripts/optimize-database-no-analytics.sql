-- ==============================================================================
-- Google AdSense Publisher Radar - Database Optimization (No Analytics)
-- ==============================================================================
-- Purpose: Create materialized views without similarweb_analytics dependency
-- ==============================================================================
...
SELECT
  ...
  -- Traffic statistics (NULL for now, will be filled when analytics table exists)
  NULL::bigint as max_traffic,
  NULL::bigint as total_traffic,
  NULL::numeric as avg_traffic,
...
SELECT
  ...
  -- Traffic statistics (NULL for now)
  NULL::bigint as max_traffic,
  NULL::bigint as total_traffic,
